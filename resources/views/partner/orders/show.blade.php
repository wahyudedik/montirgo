    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                <a href="https://www.google.com/maps?q={{ $order->location_lat }},{{ $order->location_lng }}" target="_blank" class="mt-3 inline-flex items-center gap-2 bg-blue-50 hover:bg-blue-100 text-blue-600 text-sm font-medium px-4 py-2 rounded-xl transition-colors">
