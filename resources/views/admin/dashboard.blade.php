<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-bold text-dark">📊 Admin Dashboard</h2>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    <h3 class="text-lg font-semibold text-dark mb-4">📊 Status Order</h3>
                    <div class="space-y-3">
                        @php
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                {{-- Peak Hours --}}
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    <h3 class="text-lg font-semibold text-dark mb-4">🕐 Jam Puncak</h3>
                ...
                {{-- Top Partners --}}
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    <h3 class="text-lg font-semibold text-dark mb-4">🏆 Top Partners</h3>
                    <div class="space-y-3">
                ...
                {{-- Recent Orders --}}
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    <h3 class="text-lg font-semibold text-dark mb-4">📋 Recent Orders</h3>
                    <div class="space-y-3">
